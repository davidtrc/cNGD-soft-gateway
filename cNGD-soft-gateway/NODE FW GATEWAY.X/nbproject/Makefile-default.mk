...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/NODE_FW_GATEWAY.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/NODE_FW_GATEWAY.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/CWSN\ LSI\ Node/WirelessProtocols/ESP8266.o: CWSN\ LSI\ Node/WirelessProtocols/ESP8266.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/CWSN LSI Node/WirelessProtocols" 
	@${RM} "${OBJECTDIR}/CWSN LSI Node/WirelessProtocols/ESP8266.o".d 
	@${RM} "${OBJECTDIR}/CWSN LSI Node/WirelessProtocols/ESP8266.o" 
	@${FIXDEPS} "${OBJECTDIR}/CWSN LSI Node/WirelessProtocols/ESP8266.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D"_SUPPRESS_PLIB_WARNING" -D"_DISABLE_OPENADC10_CONFIGPORT_WARNING" -I"CWSN LSI Node/Include" -I"../libs/Microchip/Include" -MMD -MF "${OBJECTDIR}/CWSN LSI Node/WirelessProtocols/ESP8266.o.d" -o "${OBJECTDIR}/CWSN LSI Node/WirelessProtocols/ESP8266.o" "CWSN LSI Node/WirelessProtocols/ESP8266.c"    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD) 
	
${OBJECTDIR}/CWSN\ LSI\ Node/WirelessProtocols/TRC.o: CWSN\ LSI\ Node/WirelessProtocols/TRC.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/CWSN LSI Node/WirelessProtocols" 
	@${RM} "${OBJECTDIR}/CWSN LSI Node/WirelessProtocols/TRC.o".d 
	@${RM} "${OBJECTDIR}/CWSN LSI Node/WirelessProtocols/TRC.o" 
	@${FIXDEPS} "${OBJECTDIR}/CWSN LSI Node/WirelessProtocols/TRC.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -D"_SUPPRESS_PLIB_WARNING" -D"_DISABLE_OPENADC10_CONFIGPORT_WARNING" -I"CWSN LSI Node/Include" -I"../libs/Microchip/Include" -MMD -MF "${OBJECTDIR}/CWSN LSI Node/WirelessProtocols/TRC.o.d" -o "${OBJECTDIR}/CWSN LSI Node/WirelessProtocols/TRC.o" "CWSN LSI Node/WirelessProtocols/TRC.c"    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD) 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/NODE_FW_GATEWAY.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_ICD3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/NODE_FW_GATEWAY.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)    -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_ICD3=1,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/NODE_FW_GATEWAY.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/NODE_FW_GATEWAY.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/NODE_FW_GATEWAY.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
